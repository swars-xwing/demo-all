...
class Test_spycloud_email_exposure():
  def setup_method(self,method,webc):#,method):
    #brows = utils.getKeyArg("--env","chrome")
    #if brows == "chrome":
  ...
  def teardown_method(self,method):#, method):
    self.driver.quit()
  ...
  def test_rick_weth_yahoo(self,webc):
    utils.bkpoint()
